...
#' @references Streuli, H. (1973). Der heutige stand der kaffeechemie, \emph{Association Scientifique International du Cafe, 6th International Colloquium on Coffee Chemistry}, Bogata, Columbia, pp. 61-72.
#' @docType data
#' @usage data(coffee)
"coffee"
...
#' @references Forina, M., Armanino, C., Lanteri, S. and Tiscornia, E. (1983). Classification of olive oils from their fatty acid composition, \emph{Food Research and Data Analysis}, Applied Science Publishers, London, pp. 189-214.
#' @docType data
#' @usage data(olive)
"olive"
